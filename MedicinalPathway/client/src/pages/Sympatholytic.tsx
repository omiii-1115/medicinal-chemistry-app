...
import { receptorInfo } from "@/data/receptorInfo";
...
const Sympatholytic = () => {
  ...
  const selectedReceptorData = selectedReceptor 
    ? receptorInfo.find(receptor => receptor.id === selectedReceptor) 
    : null;
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative z-10 min-h-screen flex flex-col p-6 pt-16">
        ...
        >
          <h1 className="text-3xl font-bold text-[#7C3AED] font-montserrat mb-2">Sympatholytic Agents</h1>
        ...
        >
          {receptorInfo.map((receptor, index) => (
            <motion.div
              key={receptor.id}
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center text-xs text-[#7C3AED]">
                  <i className="fas fa-info-circle mr-1"></i> Tap for receptor information
                </div>
              </div>
            </motion.div>
          ))}
